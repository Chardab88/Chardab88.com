...
"carson hocevar.png","ryan preece.png","gc spencer.png","neil castles.png","ted musgrave.png","possum jones.png","john sears.png","joe ruttman.png","kenny wallace.png",
 ...
 "bill dennis.png","richard childress.png","buddy arrington.png","bub king.png",
 ...
 "randy ogden.png","rick hendrick.png","roger baldwin.png","dave alonzo.png","al laqusto.png","mark stahl.png","dave mader.png", "larry foyt.png","ray black jr.png","pancho carter.png","david hobbs.png","delma cowart.png","randy baker.png","kerry earnhardt.png",
 ...
 "stewart friesen.png","david starr.png","jocko maggiacomo.png","randy macdonald.png","butch gilliland.png","shane hmeil.png","tom herbert.png","stephen leicht.png","owen kelly.png","sarel van der merwe.png","randy porter.png", "shawna robinson.png","tom hubert.png","christian fittipaldi.png",
 ...
 "derek kraus.png","curtis markham.png","patty moise.png","jeff davis.png","frank kimmel.png","jason keller.png","eric mcclure.png","andy pilgrim.png","nelson piquet jr.png","ryan reed.png",
 ...
 "mike marlar.png","will brown.png","bill lester.png","todd kleuver.png","ryan ellis.png","austin therialt.png","alon day.png","tomy drissi.png","loris hezemans.png","gary wright.png","rk smith.png","danny sullivan.png","sean woodside.png","hank parkerjr.png",
 ...
 "cameron waters.png","daniil kvyat.png","graham taylor.png","al unser jr.png","shane hall.png","dan pardus.png","johnathon davenport.png","burt myers.png","rich woodland.png","jay sauter.png",
...
const random = wallImages.length -1;
                ...
                if (imageIndex < wallImages.length) {
                    ...
                    tile.addEventListener("click", function () {
                        ...
                        if (imageIndex == random){
                            currentIndex = Math.floor(Math.random() * (wallImages.length - 1));

                            image.style.backgroundImage =
                                `url('drvimgs/${wallImages[currentIndex]}')`;
                        }
