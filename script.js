...
const wallImages = [
 ...
 "loy allen.png","stacy compton.png","jason leffler.png","brian simo.png","josh wise.png","josh bilicki.png","bobby hamiltonjr.png","ken miles.png","jack bowsher.png","tommy houston.png",
 "jack pennington.png","cole whitt.png","jeffrey earnhardt.png","travis pastrana.png","chandler smith.png","connor zilisch.png","charlie chapman.png","bill whiteley.png",
 "butch leitzinger.png","jeff purvis.png","david green.png","jan magnussen.png","jimmy horton.png","scott lagasse.png","blackie wangerin.png","dorsey schoeder.png","michael annett.png",
 ...
 "randy ogden.png","rick hendrick.png","roger baldwin.png","al laqusto.png","mark stahl.png","larry foyt.png","joe grafjr.png","pancho carter.png","delma cowart.png","kerry earnhardt.png",
 ...
 "stewart friesen.png","david starr.png","butch gilliland.png","shane hmeil.png","tom herbert.png","tom hubert.png","stephen leicht.png","sarel verde.png","shawna robinson.png",
 "ryan sieg.png","jordan taylor.png","jesse love.png","josh williams.png","ritchie petty.png","jay hedgecock.png","mike garvey.png","alex kennedy.png","bayley currey.png",
 ...
 "kyle weatherman.png","scott heckert.png","grant enfinger.png","brian ross.png","jerry hill.png","ed ferre.png","steve kinser.png","joe bessey.png","jeb burton.png",
 ...
 "hideo fukuyama.png","larry gunselmen.png","mike olsen.png","chris windom.png","terry cook.png","spencer boyd.png","rc enerson.png","mike dillon.png","spencer gallagher.png",
 "cameron waters.png","daniil kvyat.png","shane hall.png","johnathon davenport.png","burt myers.png","gary mayeda.png","shane golobic.png","denny wilson.png","geoff brabham.png",
